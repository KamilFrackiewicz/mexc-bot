...
app = FastAPI(title="MEXC Futures Bot BB Reverse")
...
def run_pair_strategy(client: MEXCClient, ps: PairState):
    try:
        ...
        # ODWROCONA: wybicie dolu = SHORT, wybicie gory = LONG
        if near_lower and ps.bb_breakout_side != "SHORT":
            ps.bb_breakout_candle = last_ts
            ps.bb_breakout_side = "SHORT"
        if near_upper and ps.bb_breakout_side != "LONG":
            ps.bb_breakout_candle = last_ts
            ...
            for ps in actives:
                try:
                    ...
                    if (gstate.be_enabled and ps.pyramid_active and ps.pyramid_side and
                        ...
                        # Srednia cena ze wszystkich wejsc
                        ...
                        be_sl = avg_price * (1 + gstate.be_sl_pct / 100) if ps.pyramid_side == "SHORT" else avg_price * (1 - gstate.be_sl_pct / 100)
